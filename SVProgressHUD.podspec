Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/peanutgao/SVProgressHUD'
  s.authors   = { 'Sam Vermette' => 'hello@samvermette.com', 'Tobias Totzek' => 'tobias@totzek.me' }
  s.source   = { :git => 'https://github.com/peanutgao/SVProgressHUD.git', :tag => s.version.to_s }
  ...
  s.subspec 'Core' do |core|
    ...
    core.resource_bundles = {
      'SVProgressHUD_Privacy' => ['SVProgressHUD/PrivacyInfo.xcprivacy']
    }
  end
